  ...
  return (
    <div name="contact" className="w-full h-screen bg-[#03547b] text-white">
      ...
      <form method="POST" action='https://getform.io/f/74ab4bb7-05af-43d2-a597-fdd637a93b81' className='max-w-[1000px] mx-auto px-8 flex flex-col justify-center h-full'>
        ...
        <input className='bg-[#dae2e6] p-2 text-black focus:outline-none' type="text" placeholder='Name' name='name' />
        <input className='my-4 p-2 bg-[#dae2e6] text-black focus:outline-none' type="email" placeholder='E-Mail' name='email' />
        <textarea className='bg-[#dae2e6] p-2 text-black focus:outline-none' name='message' rows="10" placeholder='Message'></textarea>
